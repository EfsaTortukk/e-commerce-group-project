              ...
              <article className="border border-gray-200 bg-white shadow-sm rounded p-4 lg:p-6 mb-5">
                ...
                <div class="grid sm:grid-cols-2 gap-4 mb-6">
                  {addresses?.map((address) => (
                    <label
                      class="flex p-3 border border-gray-200 rounded-md bg-gray-50 hover:border-green-400 hover:bg-green-50 cursor-pointer"
                ...
                <Link
                  href="/address/new"
                  className="px-4 py-2 inline-block text-green-600 border border-gray-300 rounded-md hover:bg-gray-100"
                >
                ...
                <div className="flex justify-end space-x-2 mt-10">
                  <Link
                    href="/cart"
                    className="px-5 py-2 inline-block text-gray-700 bg-white shadow-sm border border-gray-200 rounded-md hover:bg-gray-100 hover:text-green-600"
                  >
                    Back
                  </Link>
                  <a
